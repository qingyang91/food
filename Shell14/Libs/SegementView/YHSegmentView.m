...
static CGFloat Font_Default_size = 12;
static CGFloat Font_Selected_size = 14;
/**<< 默认字体大小 <<*/
#define YH_Font_Default [UIFont systemFontOfSize:Font_Default_size]
/**<< 选中后大小 <<*/
#define YH_Font_Selected [UIFont systemFontOfSize:Font_Selected_size]
...
- (UIScrollView *)segmentTitleView {
    if (!_segmentTitleView) {
        ...
        _segmentTitleView.backgroundColor = [UIColor colorWithHexString:@"#FF7F00"];
...
- (UIView *)indicateView {
    if (!_indicateView) {
        ...
        _indicateView.backgroundColor = UIColorWhite;
