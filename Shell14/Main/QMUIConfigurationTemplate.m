...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.backgroundColor = kAppNavColor;                                              // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
...
//    QMUICMI.navBarButtonFont = kSystemMainFont(14, UIFontWeightRegular);                                             // NavBarButtonFont : QMUINavigationButtonTypeNormal 和 UINavigationBar 上的 UIBarButtonItem 的字体
